  ...
  return (
    <div className="text-center mb-16 relative py-8">
      ...
      <div className="relative inline-block animate-fade-in">
        <h1 className="text-6xl font-black tracking-tighter mb-4 bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 via-lime-400 to-lime-200">
          مكتب رحلة هدف للحلول الرقمية
        </h1>
        <div className="absolute -right-4 -top-4 w-8 h-8 border-t-2 border-r-2 border-emerald-400/30 rounded-tr-lg"></div>
        <div className="absolute -left-4 -bottom-4 w-8 h-8 border-b-2 border-l-2 border-lime-300/30 rounded-bl-lg"></div>
      </div>
